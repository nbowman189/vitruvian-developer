...
docker-compose exec -T web sh -c "cd /app/website && flask db upgrade" || echo -e "${YELLOW}⚠ Migrations may have already run${NC}"
...
echo -e "   • Login: https://your-domain.com/auth/login"
echo -e "   • Dashboard: https://your-domain.com/dashboard"
